...
fn test_native_parser_proxy_set_option_wont_panic_even_if_the_proxy_panics() {
    assert_child_commits_suicide(|| {
        ...
        let mut proxy = ParserProxy::with_builder_and_parser(Some(PanickingParserBuilder(PhantomData)), None);
...
fn test_native_parser_proxy_deinit_wont_panic_even_if_the_proxy_panics() {
    assert_child_commits_suicide(|| {
        ...
        let mut proxy = ParserProxy::with_builder_and_parser(None, Some(PanickingParser(PhantomData)));
...
fn test_native_parser_proxy_clone_wont_panic_even_if_the_proxy_panics() {
    assert_child_commits_suicide(|| {
        ...
        let proxy = ParserProxy::with_builder_and_parser(Some(PanickingParserBuilder(PhantomData)), None);
